          ...
          <div className='grid lg:grid-cols-1 sm:ml-28 divide-y-2  sm:divide-y-96  sm:top-12  sm:divide-[#D4D4D4] sm:divide-solid sm:flex-none sm:order-1 sm:grow-0  lg:divide-[#AFD8F6] '>
            ...
            <div>
              ...
              <div>
                ...
                <button className='flex flex-row bg-[#CFE8F9] text-[#0F8AE3] lg:bg-transparent lg:ml-4 sm:bg-[#0A5C97] sm:w-23 sm:top-40 sm:rounded-lg sm:py-2 sm:px-5 sm:h-10 rounded p-2 px-6 sm:justify-center sm:items-center sm:flex-row sm:flex sm:font-normal  sm:font-sans sm:text-[#FFFFFF] sm:leading-6 sm:ml-64 '>Login</button>
                <p className='my-6 text-[#CFE8F9]  sm:font-sans sm:text-[#2A2A2A] sm:w-36 sm:h-4 sm:font-semibold sm:not-italic sm:ml-56 lg:text-[#ffffff] lg:ml-8 '>Forgot Password?</p>
                <div className='sm:w-60 sm:h-4 sm:top-164 sm:left-20 sm:gap-3 sm:flex sm:flex-row sm:items-center s sm:p-0 sm:ml-48 lg:w-184 lg:ml-8'>
                  ...
                  <Link to={'/Signup' } className='text-[#CFE8F9] sm:text-[#2A2A2A] lg:text-[#FFFFFF]  sm:w-12 sm:h-5 sm:mt-10 sm:top '>
                   Signup
                  </Link>
                </div>
              </div>
